    ...
    const fetchItineraries = async () => {
      try {
        ...
        if (data.results && data.results.length > 0) {
          // ✅ Sort itineraries by ID ascending
        ...
        {itineraries.map((itinerary) => (
          <div key={itinerary.id} className={styles['itinerary-card']}>
            <div className={styles['itinerary-header']}>
              ...
              <p className={styles['city']}>📍 {itinerary.city}</p>
            </div>
                  ...
                  <div className={styles.editorWrapper}>
                    {/* <CKEditor editor={ClassicEditor} data={itinerary.description || 'No terms available.'}
                      ...
                      config={{
                        ...
                        height: "300px",
                        ckfinder: {
                          // ✅ Optional: Django CKEditor upload endpoint
        ...
        <div className={styles['destination-slider']}>
          {/* <Slider {...sliderSettings}>
            {destination.all_images && destination.all_images.length > 0 ? (
              ...
              <img
                src={`${API_BASE_URL}${destination.primary_image || 'default-image.jpg'}`}
